...
const products = [
  { name: 'Laptop Dell Latitude', price: '$ 1,299.99', stock: '8 disponibles', description: 'Ideal para oficina y negocio' },
  { name: 'PC Gamer Ryzen', price: '$ 1,799.00', stock: '5 disponibles', description: 'Potente para diseño y gaming' },
  { name: 'Monitor 24', price: '$ 199.50', stock: '15 disponibles', description: 'Pantalla Full HD con excelente color' },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6 mt-8">
          {products.map((product) => (
            <div key={product.name} className="rounded-3xl border border-slate-800 bg-slate-900 p-6 shadow-xl">
