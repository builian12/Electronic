...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-!t2jq0p$@ztk&@^_^*f5k7kkw)px_1lvaqj!gu4a!3d+cebfc-')
...
USE_SQLITE_DB = os.getenv('DB_USE_SQLITE', 'true').lower() in {'1', 'true', 'yes', 'on'}

if USE_SQLITE_DB:
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',
            'NAME': BASE_DIR / 'db_mobile.sqlite3',
        }
    }
else:
    DATABASES = {
